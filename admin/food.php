...
<head>
	...
	<body>
        ...
        <div class="container py-4">
            <h5 style="color:#ff5722;font-weight:800">Waiting for Approval :</h5>
            <div class="accordion" id="accordionExample">
            <?php
                $did=$_COOKIE["id"];
                $result = $conn->query("SELECT food.id,food.type,food.quan,food.data,food.did,donar.name,donar.mobile FROM food INNER JOIN donar ON food.did=donar.id WHERE data='Waiting for Approval' ORDER BY food.id DESC");
