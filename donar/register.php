        ...
        <div class="container">
            <div class="row my-4">
                ...
                <div class="col-4 pt-5 pb-2 rounded" style="background-color:#f7f7f7;">
                    <form action="/donar/signup.php" class="container" method="post">
                        <h4 style="color:#ff5722;text-align:center;font-weight:800">Donar Register Form</h4>
                        <div class="mb-3">
                    ...
                    <p class="text-center">Do you have an Account? <a href="/donar/" style="color:#ff5722;">Click here</a></p>
                </div>
            </div>
        </div>
